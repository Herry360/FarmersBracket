              ...
              child: IntrinsicHeight(
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Rate the product:', style: TextStyle(fontSize: 16)),
                      Semantics(
                        label: 'Rating bar',
                        child: RatingBar(
                          rating: rating,
                      ...
                      const SizedBox(height: 16),
                      const Text('Add photos (optional):', style: TextStyle(fontSize: 16)),
                      Wrap(
                        spacing: 8,
                        children: [
                          ...photos.map((path) => Stack(
                      ...
                      Semantics(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (formKey.currentState!.validate() && rating > 0 && reviewText.isNotEmpty) {
                              // Mock review submission logic
                              // Replace with your backend/provider call as needed
                              print('Review submitted: rating=$rating, text=$reviewText, photos=$photos');
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(content: Text('Review submitted: $reviewText')),
                              );
