  ...
  Future<void> _fetchFarmsAndMarkers() async {
    ...
    _farms = [
      const Farm(
        ...
        longitude: 30.5286,
        story:
            'Green Valley is dedicated to organic farming and sustainability.',
      ...
      const Farm(
        ...
        longitude: 30.5300,
        story:
            'Sunny Acres specializes in fresh fruit and family-owned practices.',
    ...
    for (var farm in _farms) {
      _markers.add(
        Marker(
          ...
          infoWindow: InfoWindow(title: farm.name, snippet: farm.description),
              ...
              builder: (context) => AlertDialog(
                ...
                content: Text(
                  farm.description.isNotEmpty
                      ? farm.description
                      : 'Details for this farm will be shown here.',
                ),
                actions: [
                  TextButton(
                    ...
                    child: GoogleMap(
                      ...
                      onLongPress: (position) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Custom marker added at {position.latitude}, {position.longitude}',
                            ),
                          ),
                        );
                      },
      ...
      floatingActionButton: Semantics(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Marker added at initial location.'),
              ),
            );
          },
