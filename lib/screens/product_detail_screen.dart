...
class _ProductDetailScreenState extends ConsumerState<ProductDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // For demo: simulate user has purchased this product
    const bool hasPurchased = true; // Replace with orderProvider logic
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => OrderSupportChatScreen(
                            ticketId: widget.product.id,
                          ),
                        ),
                      );
                    },
