...
class _OnboardingFlowState extends State<OnboardingFlow> {
  ...
  final List<_OnboardingPageData> pages = [
    const _OnboardingPageData(
      ...
      description: 'Your gateway to fresh, local farm produce delivered to your door.',
    ),
    const _OnboardingPageData(
      lottie: 'assets/lottie/onboarding_2.json',
      title: 'Discover Fresh Farm Products',
      description: 'Browse a wide variety of organic fruits, vegetables, and dairy from local farms.',
    ),
    const _OnboardingPageData(
      lottie: 'assets/lottie/onboarding_3.json',
      title: 'Easy Ordering & Fast Delivery',
      description: 'Order in a few taps and get your produce delivered quickly and safely.',
    ),
  ];
...
class _OnboardingPageData {
  ...
  const _OnboardingPageData({required this.lottie, required this.title, required this.description});
}
