...
class FarmListScreen extends StatefulWidget {
  const FarmListScreen({super.key, required FarmModel farmModel});
                ...
                return RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final farmModel = displayedFarms[index] as FarmModel;
                      return FarmCard(
                        farm: farmModel,
                        onTap: () {
                          Navigator.pushNamed(
