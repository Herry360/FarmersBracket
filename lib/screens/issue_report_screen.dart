      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...['Wrong Item', 'Poor Quality', 'Missing Item', 'Late Delivery'].map((issue) => ListTile(
              title: Text(issue),
            ...
            if (selectedIssue == 'Wrong Item')
              Padding(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  value: receivedItem,
                  items: recentOrderItems.map((item) => DropdownMenuItem(
                    value: item,
                    child: Text(item),
                  )).toList(),
            ...
            if (showPhotoPicker)
              Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Photo picker opened (mock)')));
                  },
                ),
              ),
            const Spacer(),
            ElevatedButton(
              onPressed: selectedIssue == null || (selectedIssue == 'Wrong Item' && receivedItem == null) ? null : () {
                showDialog(
                  context: context,
                  builder: (ctx) => AlertDialog(
                    title: const Text('Issue Submitted'),
                    content: Text(selectedIssue == 'Wrong Item' || selectedIssue == 'Missing Item'
